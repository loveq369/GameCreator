...
@implementation KGCSequenceActionView
{
	KGCSequenceAction *_action;
}
...
- (IBAction)showAddMenu:(id)sender
{
	...
	NSArray *spriteActions = [(KGCSceneObject *)[_action parentObject] actions];
